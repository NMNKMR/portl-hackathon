/**
 * Dynamic Expo config. Keep APP_VARIANT + package IDs in sync with eas.json profiles.
 * Notification channel id: keep in sync with src/constants/notifications.ts (`portl`).
 */
...
/** Linked by EAS when the project was created on expo.dev */
const EAS_PROJECT_ID = '985ae7e3-0038-4855-a082-4576bccf68f0';
